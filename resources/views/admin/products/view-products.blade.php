                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!empty($product->image))
                                               <img src="{{asset('/upload/'.$product->image)}}" alt="" style="width: 100px; height: 100px">
                                        </td>
                                        @endif
                                        <td>{{$product->price}}</td>
                                        ...
                                        <td>
                                            <a href="{{url('/admin/images/'.$product->id)}}" class="btn btn-info btn-sm" title="Add images"><i class="fa fa-image"></i></a>
                                            <a href="{{url('/admin/add-attributes/'.$product->id)}}" class="btn btn-warning btn-sm" title="Add attributes"><i class="fa fa-list"></i></a>
                                            <a href="{{url('/admin/edit-product/'.$product->id)}}" class="btn btn-add btn-sm" title="Edit products"><i class="fa fa-pencil"></i></a>
