                                ...
                                <table id="table_id" class="table table-bordered table-striped table-hover">
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('admin/edit_category/'.$category->id)}}" class="btn btn-add btn-sm"><i class="fa fa-pencil"></i></a>
                                                <a href="{{url('admin/delete_category/'.$category->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i> </a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
