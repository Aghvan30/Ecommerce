                        ...
                        <div class="panel-body">
                            <form class="col-sm-6" action="{{url('admin/edit-banner/'.$bannerDetails->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" value="{{$bannerDetails->name}}" placeholder="Enter  Name" name="banner_name" id="banner_name" required>
                                </div>
                                <div class="form-group">
                                    <label>Text Style</label>
                                    <input type="text" class="form-control" value="{{$bannerDetails->text_style}}" placeholder="Text Style" name="text_style" id="text_style"  required>
                                </div>
                                <div class="form-group">
                                    <label>Content</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$bannerDetails->sort_order}}" placeholder="Sort Order" name="sort_order" id="sort_order" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    @if(!empty($bannerDetails->image))
                                        ...
                                        <img src="{{asset('upload/banners/'.$bannerDetails->image)}}" style="width:200px">
                                    @endif
